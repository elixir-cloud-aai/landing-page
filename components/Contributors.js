...
function Contributors({ contributors }) {
  ...
  const getAffiliationArray = () => {
    ...
    contributors.map((contributor) => {
      contributor?.positions?.map((position) => {
