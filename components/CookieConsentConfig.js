  ...
  languages: {
    en: {
      consent_modal: {
        ...
        description: `We use cookies to recognize your repeated visits and preferences, as well as to measure the effectiveness of our documentation and whether users find what they're searching for. With your consent, you're helping us to make our documentation better. <button type="button" data-cc="c-settings" class="cc-link"> Let me choose</button>`,
        primary_btn: {
          text: "Accept all",
