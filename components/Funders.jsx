...
function Partners({ funders }) {
  ...
  const handleSearch = (e) => {
    ...
    const newFilteredFunders = funders.filter(
      (funder) => {
        return Object.values(funder)
          .join(" ")
          .toLowerCase()
          .includes(term);
      }
              ...
              <div className="flex-grow p-5">
                ...
                <div className="md:text-xl sm:text-base text-sm mt-1 md:mt-0 dark:text-gray-200 flex flex-col md:flex-row md:gap-2">
                  ...
                  <span className="flex">
                    ...
                    <span className="md:text-xl sm:text-base text-sm ">-</span>
                    <span className="md:text-xl sm:text-base text-sm ">{formatDate(funder.timeline.end)}</span>
                  </span>
                </div>
              </div>
            </div>
