...
[React.js][res-react]. Most of the pages on the website are built by Incremental Static Regeneration scheme on server for fast client-side rendering and better SEO.
