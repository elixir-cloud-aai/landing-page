...
import { FundersComponentProps, Recipient } from './types';

const Funders: FC<FundersComponentProps> = ({ funders }) => {
  ...
  const renderReciepients = (recipients: Recipient[]) => {
            ...
            <div className="w-full rounded-lg border-2 shadow-lg hover:shadow-md my-5 hover:bg-gray-100 dark:bg-gray-900 dark:hover:bg-gray-800 dark:border-gray-800 dark:hover:border-gray-900 cursor-pointer ">
              <div className="flex md:flex-row flex-col">
                <img
                  ...
                  height="auto"
                  src={
                    context?.theme !== 'dark' ? funder.icon : funder.iconDark
                  }
                  width="auto"
                />
